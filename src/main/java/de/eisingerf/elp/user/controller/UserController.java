...
import de.eisingerf.elp.user.service.UserActionService;
...
public class UserController {
    ...
    UserController(UserActionService userActionService, UserRepository userRepository) {
    ...
    public UserDto login(HttpServletRequest request, @RequestBody LoginDto loginDto) {
        ...
        var loginRes = userActionService.login(loginDto.username(), loginDto.password());
